...
namespace AdCms.AdsWcfService.AdServiceReference {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AdCms.AdsWcfService.AdServiceReference.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AdCms.AdsWcfService.AdServiceReference.Brand Brand {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AdServiceReference.IAdDataService")]
    public interface IAdDataService {
        ...
        AdCms.AdsWcfService.AdServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<AdCms.AdsWcfService.AdServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : AdCms.AdsWcfService.AdServiceReference.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<AdCms.AdsWcfService.AdServiceReference.IAdDataService>, AdCms.AdsWcfService.AdServiceReference.IAdDataService {
        ...
        public AdCms.AdsWcfService.AdServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<AdCms.AdsWcfService.AdServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
